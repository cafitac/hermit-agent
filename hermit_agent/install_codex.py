...
from .install_flow import ensure_codex_marketplace_registered, ensure_codex_mcp_registered, remove_codex_reply_hook
...
def run_install_codex(*, cwd: str, codex_command: str = "codex", scope: str = "user") -> str:
    ...
    mcp_status = ensure_codex_mcp_registered(cwd=cwd, codex_command=codex_command)
    ...
    return (
        ...
        f"- Codex MCP registration: {mcp_status}\n"
